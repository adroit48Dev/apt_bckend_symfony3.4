...
class SkillController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $skills = $em->getRepository('EmpBundle:Skill')->findAll();
     ...
     *
     * @Route("/admin/new", name="skill_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        $skill = new Skill();
        $form = $this->createForm('EmpBundle\Form\SkillType', $skill);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('skill_index', array('id' => $skill->getId()));
     ...
     *
     * @Route("/admin/{id}", name="skill_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/admin/{id}/edit", name="skill_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Skill $skill)
    {
        $deleteForm = $this->createDeleteForm($skill);
        $editForm = $this->createForm('EmpBundle\Form\SkillType', $skill);
     ...
     *
     * @Route("/admin/{id}", name="skill_delete")
     * @Method("DELETE")
     */
