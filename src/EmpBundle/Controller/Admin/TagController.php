...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $tags = $em->getRepository('EmpBundle:Tag')->findAll();
     ...
     *
     * @Route("/admin/new", name="tag_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        $tag = new Tag();
        $form = $this->createForm('EmpBundle\Form\TagType', $tag);
     ...
     *
     * @Route("/admin/{id}/edit", name="tag_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Tag $tag)
    {
        $deleteForm = $this->createDeleteForm($tag);
        $editForm = $this->createForm('EmpBundle\Form\TagType', $tag);
     ...
     *
     * @Route("/admin/{id}", name="tag_delete")
     * @Method("DELETE")
     */
