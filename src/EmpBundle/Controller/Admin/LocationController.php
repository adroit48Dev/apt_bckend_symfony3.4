...
class LocationController extends Controller
{
     ...
     *
     * @Route("/admin/", name="location_index")
     * @Method("GET")
     */
    public function indexAction()
    {
        ...
        $locations = $em->getRepository('EmpBundle:Location')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('EmpBundle\Form\LocationType', $location);
     ...
     *
     * @Route("/admin/{id}", name="location_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/admin/{id}/edit", name="location_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Location $location)
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('EmpBundle\Form\LocationType', $location);
     ...
     *
     * @Route("/admin/{id}", name="location_delete")
     * @Method("DELETE")
     */
